...
export const CourtZoneMap: React.FC<CourtZoneMapProps> = ({ zones, title }) => {
  ...
  const ZoneCell = ({ zone }: { zone: number }) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center rounded border border-gray-600 aspect-square"
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-1 max-w-[160px]">
        <ZoneCell zone={4} /><ZoneCell zone={3} /><ZoneCell zone={2} />
        <ZoneCell zone={5} /><ZoneCell zone={6} /><ZoneCell zone={1} />
      </div>
